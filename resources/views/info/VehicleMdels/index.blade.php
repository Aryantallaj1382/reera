...
@section('content')
    <div class="max-w-3xl mx-auto p-6">
        ...
        {{-- فرم اضافه کردن مدل --}}
        <form method="POST" action="{{ route('VehicleBrand.models.store', $brand) }}" class="flex gap-2 mb-6">
            @csrf
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            @foreach($models as $model)
                <div class="border rounded-xl p-4 flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition">
                    ...
                    <form method="POST" action="{{ route('VehicleBrand.models.destroy', [$brand, $model]) }}"
