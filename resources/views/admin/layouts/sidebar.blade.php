        ...
        <ul class="sidebar-menu">
            <li class="item-li i-courses">
                ...
                <ul class="submenu" style="display: none;">
                    ...
                    <li><a class="no-before" href="{{route('vehicle.index')}}">آگهی‌های وسایل نقلیه</a></li>
                    <li><a class="no-before" href="{{route('digital.index')}}">آگهی‌های دیجیتال</a></li>
                    <li><a class="no-before" href="{{route('kitchen.index')}}">آگهی های آشپزخانه</a></li>
                    <li><a class="no-before" href="{{route('service.index')}}">آگهی های خدمات</a></li>
                    <li><a class="no-before" href="{{route('personal.index')}}">آگهی های وسایل شخصی</a></li>
                    <li><a class="no-before" href="{{route('ticket.index')}}">آگهی های سرگرمی و فراغت</a></li>
                    <li><a class="no-before" href="{{route('recuitment.index')}}">آگهی های استخدام و کاریابی</a></li>
