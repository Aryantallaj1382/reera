...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('housemates', function (Blueprint $table) {
            ...
            $table->text('text');
            $table->string('distance_from_shopping_center');
            $table->string('distance_from_taxi_stand');
            $table->string('distance_from_gas_station');
            $table->string('distance_from_hospital');
            $table->string('distance_from_bus_station');
            $table->string('distance_from_airport');
