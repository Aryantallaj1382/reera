...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('kitchen_brands', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('kitchen_ads', function (Blueprint $table) {
            $table->id();
            $table->foreignId('ad_id')->unique()->constrained('ads')->onDelete('cascade');
            $table->foreignId('kitchen_brand_id')->constrained('kitchen_brands')->onDelete('cascade');
            $table->foreignId('kitchen_type_id')->constrained('kitchen_type')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('kitchen_ads');
    }
};
