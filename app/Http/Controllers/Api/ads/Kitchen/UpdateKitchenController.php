...
class UpdateKitchenController extends Controller
{
    public function get($id)
    {
        ...
        $return = [
            ...
            'first' => [
                ...
                'type' => $ad->type,
                'title' => $ad->title,
                'kitchen_brand_id' => $ad->kitchenAds->kitchen_brand_id,
                'kitchen_type_id' => $ad->kitchenAds->kitchen_type_id,
            ],
            'second' => [
            ...
            'fifth' => [
                ...
                'other_phone' => $ad->kitchenAds->other_phone,
                'other_phone_number' => $ad->kitchenAds->other_phone_number,
            ],
            'sixth' => [
                'currencies_id' =>$ad->kitchenAds?->currency?->title,
